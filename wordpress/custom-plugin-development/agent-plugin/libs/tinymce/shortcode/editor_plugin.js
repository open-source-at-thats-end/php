(function() {
  ...
  tinymce.PluginManager.requireLangPack('OREShortCodes');

  tinymce.create('tinymce.plugins.OREShortCodesPlugin', {
    /**
    ...
    init : function(ed, url) {
      ...
      // tinyMCE.activeEditor.execCommand('mceOREShortCodes');
      ed.addCommand('mceOREShortCodes', function() {
        // debugger;
        ed.windowManager.open( {
          file : url + '/dialog.php',
          width : 450 + ed.getLang(
              'OREShortCodes.delta_width', 0),
          height : 300 + ed.getLang(
              'OREShortCodes.delta_height', 0),
          inline : 1
        }, {
      ...
      // Register OREShortCodes button
      ed.addButton('OREShortCodes', {
        title : 'Listing Shortcode Generator',
        cmd : 'mceOREShortCodes',
      ...
      ed.onNodeChange.add(function(ed, cm, n) {
        cm.setActive('OREShortCodes', n.nodeName == 'IMG');
      });
    },
    ...
    getInfo : function() {
      return {
        longname : 'ORE Shortcode Generator',
        author : 'oequal',
        authorurl : 'http://www.oequal.com',
        infourl : 'http://www.oequal.com',
        version : "1.0"
      };
    }
  });
  ...
  // Register plugin
  tinymce.PluginManager.add('OREShortCodes',tinymce.plugins.OREShortCodesPlugin);
})();