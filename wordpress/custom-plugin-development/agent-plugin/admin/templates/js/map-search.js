...
//console.log('lkladklkdl');
    ...
    jQuery('#btn_draw').on('click', function(){
        jQuery("#btn_draw").addClass('hide').removeClass('show');
        jQuery("#btn_cancel").addClass('show').removeClass('hide');
    ...
    jQuery('#btn_cancel').on('click', function() {
        ...
        jQuery("#btn_draw").removeClass('hide').addClass('show');
        jQuery("#btn_remove").addClass('hide').removeClass('show');
    });
...
function BindMap()
{
    ...
    if(polygonString != '') {
        ...
        jQuery("#btn_remove").addClass('hide');
        jQuery("#btn_draw").addClass('showhid').removeClass('hide');
    }
    mapZoom();
}
...
function showButton()
{
    jQuery("#btn_remove").addClass('show').removeClass('hide');
    jQuery("#btn_cancel").addClass('hide').removeClass('show');
    jQuery("#btn_draw").addClass('hide').removeClass('show');
}
...
function removePolygon()
{
    jQuery('#btn_remove').click(function(){
        ...
        jQuery("#btn_remove").addClass('hide');
        jQuery("#btn_remove").removeClass('show');
        jQuery("#btn_draw").removeClass('hide').addClass('show');
