...
function getMainBoxHtml(obj, fav) {
    ...
    if(obj.subdiv == '')
        {
            var sclass = 'pt-5 te-p-5'
        }
        else{
            var sclass = 'pt-6 te-p-6'
        }
    ...
    infoHtml += '<div class="te-smooth-gradient te-property-details te-animate text-white position-absolute te-z-index-99 '+sclass+' "><div class="-te-gradient te-trans  te-property-details te-animate px-3 py-2 text-white position-absolute te-z-index-99">';
