...
function getMainBoxHtml(obj, fav) {
    ...
    if (hideAddress != undefined && hideAddress == 'Yes')
    {
        ...
        else /*if (isloginReq != undefined && isloginReq == 'Yes')*/ {
            // listing_address = '<div class="te-property-title text-truncate te-font-size-11 te-font-weight-400">' + obj.Address2 + '</div>';
            listing_address = '<div><span href="JavaScript:void(0);" class="popup-modal-sm te-property-title text-truncate te-font-size-13 te-font-weight-400" aria-label="button" data-toggle="modal" data-target="MemberLogin" data-url="' + Site_Url + memberDetail + '/?action=member-login&mlsNum=' + obj.Key + '"> Register For Details </span></div>';
        }
    }
    else{
        listing_address = '<div class="te-property-title text-truncate te-font-size-11 te-font-weight-400">' + obj.Address2 + '</div>';
    ...
    /*if (hideAddress != undefined && hideAddress == 'Yes') {
        if (isUserLoggedIn != undefined && isUserLoggedIn != '' && isUserLoggedIn == true) {
            popup = '<a href="'+ Site_Url+obj.SFUrl+'" class="te-property-card te-font-family d-block te-property-gradient position-relative overflow-hidden dflt-style te-style-default">';
            listing_address = '<div class="te-property-title text-truncate te-font-size-11 te-font-weight-400">' + obj.Address2 + '</div>';
        }else{
            popup = '<a href="JavaScript:void(0);" class="popup-modal-sm te-property-card te-font-family d-block te-property-gradient position-relative overflow-hidden dflt-style te-style-default" aria-label="button" data-toggle="modal" data-target="MemberLogin" data-url="' + Site_Url + memberDetail + '/?action=member-login&mlsNum=' + obj.Key + '">';
            listing_address = '<div class="te-property-title text-truncate te-font-size-13 te-font-weight-400"> Register For Details </div>';
        }
    }else{
        listing_address = '<div class="te-property-title text-truncate te-font-size-11 te-font-weight-400">' + obj.Address2 + '</div>';
        popup = '<a href="'+ Site_Url+obj.SFUrl+'" class="te-property-card te-font-family d-block te-property-gradient position-relative overflow-hidden dflt-style te-style-default">';
    ...
    if (agent_Profile_Id != undefined && agent_Profile_Id != '' ) {
        infoHtml += '<a href="' + Site_Url + obj.SFUrl + "aid-" + agent_Profile_Id + '/" class="te-property-card te-font-family d-block te-property-gradient position-relative overflow-hidden dflt-style te-style-default">';
    }
    else{
