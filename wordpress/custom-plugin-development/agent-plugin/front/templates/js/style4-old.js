...
function getMainBoxHtml(obj, fav) {
    ...
    infoHtml += '<div  class="'+h_class+' d-block te-property-gradient position-relative overflow-hidden">';
    ...
    infoHtml += '<div class="style4-title text-truncate te-font-size-14">'+ obj.Address +'</div>';
    ...
    {
        infoHtml += '<div class="style4-features te-font-size-14">' + obj.Bed + ' Beds <span>|</span> ' + obj.BathsFull + ' Baths <span>|</span> ' + numberFormat(obj.Sqft) + ' Sq Ft <span class="float-right"><a href="' + Site_Url + obj.SFUrl + '" class="btn-style4 text-uppercase">Details</a></span></div>';
    }
    else
    {
        infoHtml += '<div class="style4-features te-font-size-14">' + numberFormat(obj.Sqft) + ' Sq Ft <span class="float-right"><a href="' + Site_Url + obj.SFUrl + '" class="btn-style4 text-uppercase">Details</a></span></div>';
    }
