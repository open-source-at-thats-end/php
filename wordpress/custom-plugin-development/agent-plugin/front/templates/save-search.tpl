...
{*    <div class="row">
    ...
    <div class="col-12 col-sm-12 col-md-12 col-lg-12 pl-0 form-group">
        <p>
            {if isset($arrSearchParams.addval)}
            ...
            {if isset($arrSearchParams.horse_yn) && !empty($arrSearchParams.horse_yn)}
                <strong>Horse Amenities: </strong> {$arrSearchParams.horse_yn|capitalize}<br />
            {/if}
