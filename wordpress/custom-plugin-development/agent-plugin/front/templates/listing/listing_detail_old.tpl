...
<section class="d-none d-md-block">
	<div class="container  te-font-family con-div px-md-1 px-lg-2 px-xl-0">
		<div class="row py-md-3 py-lg-4 py-4 border-bottom border-dark">
			...
			<div class="col-xl-1 col-lg-2 col-md-6 align-self-center px-md-1 px-lg-0 pb-3 pb-lg-0 crypto-data">
				...
				<ul class="d-flex p-0 te-font-size-12 justify-content-between- justify-content-center py-1 py-xl-3 text-white crypto-box">
					...
					<li class="px-2- px-3 text-center"><img class="d-block mx-auto mb-1" src="{$Site_Url}wp-content/plugins/CustomWpPlugin/upload/pictures/bitcoin.png" alt="bitcoin"> <span class="te-font-size-7 text-dark font-weight-bold">APPROX</span> <span class="d-block te-font-size-11 te-font-weight-600 text-dark">{$bitcoinPrice|number_format}</span></li>
					<li class="px-2- px-3 text-center"><img class="d-block mx-auto mb-1" src="{$Site_Url}wp-content/plugins/CustomWpPlugin/upload/pictures/etherium.png" alt="etherium"> <span class="te-font-size-7 text-dark font-weight-bold">APPROX</span> <span class="d-block te-font-size-11 te-font-weight-600 text-dark">{$etheriumPrice|number_format}</span></li>
					{*<li class="px-2 text-center"><img class="d-block mx-auto mb-1" src="{$Site_Url}wp-content/plugins/CustomWpPlugin/upload/pictures/cardano.png" alt="cardano"> <span class="te-font-size-7 text-black font-weight-bold">APPROX</span> <span class="d-block te-font-size-11 te-font-weight-600 text-black">{$cardanoPrice|number_format}</span></li>*}
				</ul>
				{/if}
			...
			<div class="col-xl-2 col-lg-1 col-md-6 px-lg-0 align-self-center te-heading-save-share-button order-2 order-lg-1 pb-3 pb-md-0 text-lg-right">
				<div class="dropdown d-inline-block mx-1- mx-lg-0-">
					<button id = "share-btn" class="btn btn-sm dropdown-toggle te-font-size-13 te-btn- text-white- shadow-none  py-2 py-lg-2 px-xl-3 px-lg-2 te-share-propery-detail rounded-0 w-100 lpt-btn- lpt-btn-txt- btn-gray" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					...
					<div class="dropdown-menu border rounded-0" aria-labelledby="dropdownMenuButton">
						...
						<a class="dropdown-item font-size-14 py-1" href="mailto:?subject=Share Property&body={$detail_url}" target="_blank"><i class="fas fa-envelope pr-2 pr-2"></i> Email</a>
					</div>
				</div>
				{if $arrConfig['OtherConfig']['login_enable'] == 'Yes'}
					<span class="fav-link-container" id="fav-link-container">
						{if $isUserLoggedIn == true}
							...
							{/if}
						{else}
							<a class="btn btn-sm te-btn- text-white- te-font-size-13 shadow-none py-2 py-lg-2 px-xl-3 px-lg-2 te-save-propery-detail popup-modal-sm rounded-0 mx-1- mx-lg-0- lpt-btn- lpt-btn-txt- btn-gray" data-toggle="modal" data-target="MemberLogin" data-url="{$Site_Url}{Constants::TYPE_MEMBER_DETAIL}/?action=member-login&ReqType=AddFav&mlsNum={$ListingID_MLS}" href="JavaScript:void(0);" role="button" title="Add to favorites"><i class="far fa-heart fa-2x pr-1 align-middle"></i> Save</a>
						{/if}
					</span>
				{/if}
			</div>
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-4 mt-md-0" id="overview-hash">
						...
						<h6 class=" text-left mb-4 txt-heading txt-color">
							...
							{/if}
							{if $Record.SQFT > 0}{$Record.SQFT|number_format}{else} 0 {/if}Sq Ft
						</h6>
