...
{if isset($isPredefined) && $isPredefined == true && isset($isGrid) && $isGrid == 'true'}
	...
	<div class="row te-search-filter-row- justify-content-between pre-filter-line pb-2 pr-1- border-bottom- bg-white {if isset($isGrid) && $isGrid == 'true' && isset($isstyle) && ($isstyle !== false)} px-3 {/if}">
		{if isset($psearch_display_tab) && $psearch_display_tab == 'Yes' && isset($tabs) && $tabs !== 'false'}
			<div class="col-12 {if isset($isGrid) && $isGrid == 'true'}col-xl-8 col-lg-8{else}col-xl-12 col-lg-12{/if} col-md-8  pl-md-2  pr-md-0  px-1 text-md-left text-center align-self-center btn-gray py-2 border-btm pl-xl-3 list-options">
		...
		{/if}
		<div class="col-12 {if isset($isGrid) && $isGrid == 'true'}col-xl-4 col-lg-4 {if isset($psearch_display_tab) && $psearch_display_tab == 'No'}text-sm-right{/if} {if isset($isPredefined) && $isPredefined == true} {if isset($psearch_display_tab) && $psearch_display_tab == 'Yes'} justify-content-between justify-content-sm-center {else} justify-content-between justify-content-sm-end {/if}font-size-sm-10 {if cw::$screen !== 'XS'}p-unset{/if} justify-content-md-end px-xl-3 {/if} {else} justify-content-between justify-content-sm-end {if isset($psearch_display_tab) && $psearch_display_tab == 'Yes'}col-xl-12 col-lg-12 mt-lg-2 {else}col-xl-6 col-lg-6 {/if}{/if}   px-1- px-md-0-  text-center {if isset($psearch_display_tab) && $psearch_display_tab == 'Yes'} btn-gray col-md-4 justify-content-between py-1 {else} btn-gray col-md-12 py-2 {/if}  pt-lg-0- pt-2- d-flex d-md-block-  px-2 px-xl-2 py-xl-2 py-md-0 pb-2- {*{if isset($psearch_display_tab) && $psearch_display_tab == 'Yes' && cw::$screen !== 'XS'}p-unset{/if}*}">
...
{if !isset($isHeading) || (isset($isHeading) && $isHeading !== 'false' && $isHeading !== false)}
	...
	<div class="{if isset($isPredefined) && $isPredefined == true && ($device != 'XS' && $device != 'SM' && $device != 'MD')}col {if isset($isGrid) && $isGrid == 'true'}col-lg-4 col-xl-5{else}col-xl-7{/if} px-0{else}row {if isset($isPredefined) && $isPredefined == true }border-sm-btm {/if}{/if}  {if isset($isPredefined) && $isPredefined == true }pre-search-arrow py-1 py-md-0{/if} justify-content-between {if isset($psearch_generate_mrktreport) && $psearch_generate_mrktreport == 'No'}{if cw::$screen == 'XS' || cw::$screen == 'SM'}pt-2{/if}{/if}">
		<div class="{if isset($isPredefined) && $isPredefined == true}col-xl-12 col-md-12 d-flex{else}col-xl-9{/if}  col-lg-8 col-md-auto col-sm-auto px-2 align-self-center">
			{if isset($presearch_title) && $presearch_title != '' && cw::$screen != 'MD'}
				<h1 class="te-search-property-title  te-font-family mt-xl-2 pt-1 pt-md-0 pb-0 mb-0 txt-heading heading_txt_color col-10 col-xl-12 d-lg-block- d-xl-block- heading-font d-sm-none- heading-truncate- mr-auto">{$presearch_title|capitalize}</h1>
			{elseif isset($arrSearchCriteria.addtype) && $arrSearchCriteria.addtype == 'cs'}
				...
				<h1 class="te-search-property-title te-font-family mt-xl-2 pt-1 pt-md-0 pb-0 mb-0 txt-heading heading_txt_color col-10 col-xl-12 d-lg-block- d-xl-block- heading-font d-sm-none- heading-truncate- mr-auto">{$arrSearchCriteria.addval} Real Estate & Homes For Sale</h1>
			{/if}
			{if isset($isGrid) && $isGrid !== 'true'}
				<div class="col-2 d-block- d-xl-none align-self-center- mt-1 px-3 {if isset($isPredefined) && $isPredefined == 'true'}d-sm-none d-block{else} d-none {/if}">
	...
	{*<div class="row mb-2 d-xl-none px-2- ">*}
		...
		{/if}*}
	{*</div>*}
{if isset($isPredefined) && $isPredefined == true && ($device != 'XS' && $device != 'SM' && $device != 'MD')}<div class="col {if isset($isGrid) && $isGrid == 'true'}col-md-auto col-lg-8 col-xl-7{else}col-xl-5{/if}">{/if}
	<div id ="sort_content_end" class="row {if isset($isPredefined) && $isPredefined == true && ($device != 'XS' && $device != 'SM' && $device != 'MD')} {if isset($isGrid) && $isGrid == 'true'}float-right {/if}{/if} {if isset($isGrid) && $isGrid == 'true' || (!isset($presearch_title) && $presearch_title == '' && (!isset($arrSearchCriteria.addtype) && $arrSearchCriteria.addtype == ''))}justify-content-between{/if} {if isset($isPredefined) && $isPredefined == true }pre-search-arrow {else} {if (!isset($presearch_title) && $presearch_title == '') && (!isset($arrSearchCriteria.addtype) && $arrSearchCriteria.addtype == '')}mt-xl-1 mt-0{/if}{/if} mb-2- mb-xl-0 px-2 px-md-2 px-xl-0-">
		{if cw::$screen == 'XS' || cw::$screen == 'SM' || cw::$screen == 'MD' }
			{if isset($presearch_title) && $presearch_title != ''}
				<h1 class="te-search-property-title te-font-family mt-xl-2 mt-2 pt-1 pt-md-0 mb-0 txt-heading heading_txt_color col-auto col-sm-6 col-lg-6 d-sm-block d-none heading-font heading-truncate- mr-auto">{$presearch_title|capitalize}</h1>
			{elseif isset($arrSearchCriteria.addtype) && $arrSearchCriteria.addtype == 'cs'}
				{*        {if isset($arrSearchCriteria.addtype) && $arrSearchCriteria.addtype == 'cs'}*}
				<h1 class="te-search-property-title te-font-family mt-xl-2 mt-2 pt-1 pt-md-0 mb-0 txt-heading heading_txt_color col-auto col-sm-6 col-lg-4 d-sm-block d-none heading-font heading-truncate- mr-auto">{$arrSearchCriteria.addval} Real Estate & Homes For Sale</h1>
			{/if}
		{/if}
		{if isset($isPredefined) && $isPredefined == true && isset($isGrid) && $isGrid == 'true'}
...
{if isset($isGrid) && $isGrid !== 'true'}
	...
	{else}
		<div class="{if (!isset($isstyle) || (isset($isstyle) && ($isstyle == false || $isstyle == 4 || $isstyle == 6 || $isstyle == 5 || $isstyle == 10))) || (!isset($isGrid) || (isset($isGrid) && $isGrid == 'false' && (isset($isstyle) && ($isstyle !== false) )))}row {/if} {if isset($isstyle)  && ($isstyle == 4 || $isstyle == 5 || $isstyle == 6) || ($isstyle == 10 && $device == 'MD' && $device != 'XS' && $device != 'SM')}px-4{/if} {if isset($isPredefined) && $isPredefined == true && $isstyle == ''} px-xl-3 px-2 px-md-3 {/if} {if isset($predefinedId) && $predefinedId != ''}pms-listing-result-{$predefinedId}{else}pms-listing-result{/if}">
...
{if !isset($isstyle) || (isset($isstyle) && $isstyle != 1 && $isstyle != 2 &&  $isstyle != 3 && $isstyle != 4 && $isstyle != 7 && $isstyle != 8 && $isstyle != 9 && $isstyle != 11 && $isstyle != 12) || (isset($isstyle) && $isstyle == 5 && $page_size >= 10) || (isset($isstyle) && $isstyle == 6 && $page_size >= 10)}
	<div class="row py-2">
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 px-2- {if $isstyle == 10} style-10 px-xl-2 px-md-4- px-lg-4- {/if}">
			<nav aria-label="...">
...
{*{if $total_record > 0 && $disclaimer == 'true'}
	*}{*{if isset($isstyle) && $isstyle == true && isset($isPredefined) && $isPredefined == true}
	{else}*}{*
		<div id = "disclaimer-section" class="d-none px-2">
			...
			*}{*{if (isset($sys_name) && $sys_name == 'ACTRIS')}*}{*
			...
			{elseif isset($sys_name) && $sys_name == 'SEFMIAMI'}
				<div class="disclaimer-txt-color">
					...
					<p align="justify">Miami Association of Realtors MLS data last updated on {$MLS_last_update_date}.</p>
...
<input type="hidden" id="pid" name="pid" value="{$predefinedId}">
	{if isset($predefinedId) && $predefinedId != '' }
	<input type="hidden" class="json" id="json_{$predefinedId}" name="json_{$predefinedId}" value="{$jsonMapData}" data-pid="{$predefinedId}">
		<input type="hidden" class="json_css" id="css_{$predefinedId}" name="css_{$predefinedId}" value="{$attr.css}" data-pid="css_{$predefinedId}">
		<input type="hidden" class="json_title" id="title_{$predefinedId}" name="title_{$predefinedId}" value="{$attr.title}" data-pid="title_{$predefinedId}">
