<script type="text/javascript">
	...
	var login_enable = '{$arrConfig['OtherConfig']['login_enable']}';
	...
	<div class="single-property-gallery-container">
		...
		{if $Record.mls_is_pic_url_supported == 'Yes'}
			{if $Record.PictureArr.large|count > 0}
				<a class="btn btn-sm sp-gallery-btn {*te-btn*} text-white- text-uppercase p-2 shadow-none rounded-0 position-absolute te-font-size-14 te-pd-gallery-view-more lpt-btn lpt-btn-txt hover-color hover-text-color {if $Record.ListingStatus == 'Closed'}disabled-sold{/if}" href="javascript::void(0);" role="button">{$Record.PictureArr.large|count} more photos</a>
				<!-- <a href="#" class="sp-gallery-btn">View Photos</a> -->
			{/if}
		{else}
			{if $Record.PictureArr|count > 0}
				<a class="btn btn-sm sp-gallery-btn {*te-btn*} text-white- text-uppercase p-2 shadow-none rounded-0 position-absolute te-font-size-14 te-pd-gallery-view-more lpt-btn lpt-btn-txt hover-color hover-text-color {if $Record.ListingStatus == 'Closed'}disabled-sold{/if}" href="javascript::void(0);" role="button">{$Record.PictureArr|count} more photos</a>
				<!-- <a href="#" class="sp-gallery-btn">View Photos</a> -->
			{/if}
		{/if}
		{*{if $Record.PictureArr.large|count > 0}
...
<section class="d-none d-md-block ">
	<div class="container te-font-family con-div px-md-1 px-lg-2 px-xl-0 header-section-detail-page">
		...
		<div class="row py-md-3 py-lg-4 py-4 mx-0">
			<div class="col-xl-6 col-lg-6 col-md-6 px-lg-0 align-self-center div-add pb-3 pb-lg-0">
				{if $hideAddress != '' && $hideAddress == 'Yes'}
					...
					{else}
						<p class="text-left pb-0 mb-0 te-address-heading-property-details txt-color">
							<a class="popup-modal-sm text-dark te-font-size-17" data-toggle="modal" data-target="MemberLogin" data-url="{$Site_Url}{Constants::TYPE_MEMBER_DETAIL}/?action=member-login&mlsNum={$ListingID_MLS}" href="JavaScript:void(0);" role="button">Register For Details</a>
						</p>
					{/if}
				{else}
					<p class="text-left pb-0 mb-0 te-address-heading-property-details txt-color">{$Record.address_short}</p>
				{/if}
				<p class="text-left pb-0 mb-0 txt-color- text-secondary">{$Record.CityName}, {$Record.State} {$Record.ZipCode}</p>
			...
			<div class="col-xl-6 col-lg-6 col-md-6 {*align-self-center*} div-info {*price-detail-section*} px-0 pb-3 pb-lg-0">
				<div class="btn-group btn-group-sm te-heading-property-details-features d-inline-block my-1" role="group" aria-label="Basic example">
					<button type="button" class="btn px-2 px-xl-5 py-0 text-dark shadow-none">
						...
						<p class="width-max-content mb-0 head ">{$currency}{if $Record.ListingStatus == 'Closed'}{$Record.Sold_Price|number_format}{else}{$Record.ListPrice|number_format}{/if}</p>
					...
					{if !in_array($Record.PropertyType, $arrPType) && !in_array($Record.SubType, $arrSType)}
						<button type="button" class="btn px-2 px-xl-4 py-0 text-dark shadow-none">
							<p class="width-max-content mb-0 head ">{$Record.Beds|number_format}</p>
							<p class="mb-0 text-secondary">Beds</p>
						</button>
						<button type="button" class="btn px-2 px-xl-4 py-0 text-dark shadow-none">
							<p class="width-max-content mb-0 head ">{$Record.BathsFull|number_format}</p>
							<p class="mb-0 text-secondary">Baths</p>
						</button>
						<button type="button" class="btn px-2 px-xl-3 py-0 text-dark shadow-none">
							<p class="width-max-content mb-0 head ">{$Record.BathsHalf|number_format}</p>
							<p class="mb-0 text-secondary">Half Baths</p>
						</button>
					{/if}
					{if $Record.SQFT != ''}
						<button type="button" class="btn px-2 pl-xl-4 py-0 text-dark shadow-none">
							<p class="width-max-content mb-0 head ">{$Record.SQFT|number_format}</p>
			...
			<div class="row bg-white position-sticky section-hash-link ">
				<div class="col-xxl-10 col-xl-9 col-lg-9 col-md-6 col-sm-12 col-12 d-none d-lg-block py-4 pl-0">
					<ul class="list-inline m-0 text-left">
						...
						{if is_array($arrSimilar) && count($arrSimilar) > 0}<li class="list-inline-item px-2"><a class="text-dark" href="#te-similar-listings-hash"><h6 class="txt-heading text-secondary text-uppercase pb-0">Similar Properties</h6></a></li>{/if}
					</ul>
				</div>
				<div class="col-xxl-2 col-xl-3 col-lg-3 col-md-6 col-sm-12 px-lg-0 align-self-center te-heading-save-share-button order-2 order-lg-1 pb-3 pb-md-0 text-lg-right ">
					...
					{if $arrConfig['OtherConfig']['login_enable'] == 'Yes'}
						...
						{if $isUserLoggedIn == true}
							...
							{/if}
						{else}
							<a class="btn btn-sm te-btn- text-white- te-font-size-13 shadow-none py-2 py-lg-2 px-lg-3 px-xl-4 te-save-propery-detail popup-modal-sm rounded-0 mx-1 mx-lg-0 lpt-btn- lpt-btn-txt- btn-gray" data-toggle="modal" data-target="MemberLogin" data-url="{$Site_Url}{Constants::TYPE_MEMBER_DETAIL}/?action=member-login&ReqType=AddFav&mlsNum={$ListingID_MLS}" href="JavaScript:void(0);" role="button" title="Add to favorites"><i class="far fa-heart fa-2x pr-1 align-middle"></i> Save</a>
						{/if}
					</span>
					{/if}
				</div>
		...
		<div class="row pt-4  te-font-family">
			...
			<div class="col-xl-5 col-lg-6 col-md-6 align-self-center pb-3">
				<div class="btn-group btn-group-sm te-heading-property-details-features mobile d-inline-block my-1" role="group" aria-label="Basic example">
					<button type="button" class="btn pl-0 pr-0 py-0 text-dark shadow-none">

						<p class="width-max-content mb-0 te-pd-features-valuemobile-value head  pl-0" >{$currency}{if $Record.ListingStatus == 'Closed'}{$Record.Sold_Price|number_format}{else}{$Record.ListPrice|number_format}{/if}</p>
						<p class="mb-0 text-secondary">Price</p>
					</button>
					{if !in_array($Record.PropertyType, $arrPType) && !in_array($Record.SubType, $arrSType)}
						<button type="button" class="btn px-2 400bd py-0 text-dark shadow-none">
							<p class="width-max-content mb-0 head ">{$Record.Beds|number_format}</p>
							<p class="mb-0 text-secondary">Beds</p>
						</button>
						...
						<button type="button" class="btn px-2 360pb py-0 text-dark shadow-none">
							<p class="width-max-content mb-0 head ">{$Record.BathsHalf|number_format}</p>
							<p class="mb-0 text-secondary">Half Baths</p>
						</button>
					{/if}
					<button type="button" class="btn pl-2 360ps pr-0 py-0 text-dark shadow-none">
						<p class="width-max-content mb-0 head ">{$Record.SQFT|number_format}</p>
						<p class="mb-0 text-secondary">Sq. Ft</p>
					</button>
				</div>
...
<section class="te-property-details-full te-font-family pt-4 pb-5 py-md-4">
	<div class="container con-div px-0">
		...
		<div class="row mt-md-4">
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 col-12 leftbar {if cw::$screen > 'LG'}pr-5{/if}">
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mt-4 mt-md-0" id="overview-hash">
						...
						{if isset($Record.Description) && $Record.Description != ''}
							<p class="te-font-size-14 txt-color">
								{*{$Record.Description}*}
								{assign var=Description value={str_replace("â€™","'",$Record.Description)}}
								{$Description = str_replace("â€™","'",$Record.Description)}
								...
								<div class="row">
									<div class="col-6">
										<table class="table te-font-size-14 te-table-property-detail table-borderless table-hover">
											...
											<tr>
												<td nowrap>Price</td>
												<td class="text-right">{$currency}{if $Record.ListingStatus == 'Closed'}{$Record.Sold_Price|number_format}{else}{$Record.ListPrice|number_format}{/if}</td>
											</tr>
											{if $Record.SQFT > 0}
												<tr>
													<td nowrap>Square Feet</td>
													<td class="text-right">{$Record.SQFT|number_format}</td>
												</tr>
											{/if}
											{if $Record.Beds > 0}
												<tr>
													<td nowrap>Beds</td>
													<td class="text-right">{$Record.Beds|number_format}</td>
												</tr>
											{/if}
											{if isset($Record.Tax) && $Record.Tax != ''}
												<tr>
													<td nowrap>Taxes</td>
													<td class="text-right">{$currency}{$Record.Tax|number_format} / year</td>
												</tr>
											{/if}
											{if isset($Record.Subdivision) && $Record.Subdivision != ''}
												<tr>
													<td nowrap>Subdivision</td>
													<td class="text-right">{$Record.Subdivision}</td>
												</tr>
											{/if}
											{if isset($Record.Is_Waterfront) && $Record.Is_Waterfront !=''}
												<tr>
													<td nowrap>Waterfront</td>
													<td class="text-right">{$Record.Is_Waterfront}</td>
												</tr>
											{/if}
											{if (isset($Record.HOAFee) && $Record.HOAFee != '') || (isset($Record.HOAFrequency) && $Record.HOAFrequency != '')}
												<tr>
													<td nowrap>HOA Fees</td>
													<td class="text-right">{if $Record.HOAFee != ''}{$currency}{$Record.HOAFee|number_format}{/if} {if $Record.HOAFrequency != ''}/ {$Record.HOAFrequency}{/if}</td>
												</tr>
											{/if}
											</tbody>
										</table>
									...
									<div class="col-6">
										<table class="table te-font-size-14 te-table-property-detail table-borderless table-hover">
											...
											{if isset($Record.PropertyType) && $Record.PropertyType != ''}
												<tr>
													<td nowrap>Type</td>
													<td class="text-right">{$Record.PropertyType}</td>
												</tr>
											{/if}
											{if $Record.SQFT > 0 && $Record.ListPrice > 0}
												<tr>
													...
													<td class="text-right">{$currency}{$pripsqft|number_format}</td>
												</tr>
											{/if}
											{if $Record.BathsFull > 0}
												<tr>
													<td nowrap>Baths</td>
													<td class="text-right">{$Record.BathsFull|number_format}</td>
												</tr>
											{/if}
											<tr>
												<td nowrap>MLS#</td>
												<td class="text-right">{$Record.MLS_NUM}</td>
											</tr>
											{if isset($Record.YearBuilt) && $Record.YearBuilt != ''}
												<tr>
													<td nowrap>Year Built</td>
													<td class="text-right">{$Record.YearBuilt}</td>
												</tr>
											{/if}
											{if isset($Record.ListingStatus) && $Record.ListingStatus != ''}
												<tr>
													<td nowrap>Status</td>
													<td class="text-right">{$Record.ListingStatus}</td>
												</tr>
											{/if}
											</tbody>
										</table>
					...
					<div class="col-xl-12 col-lg-12 col-md-6 col-sm-12 col-12 Featured-listings pt-5 d-block d-md-none">
						...
						<table class="table te-font-size-14 te-table-property-detail table-borderless table-hover">
							...
							{if $Record.SQFT > 0}
								<tr>
									<td nowrap>Square Feet</td>
									<td>{$Record.SQFT|number_format}</td>
								</tr>
							{/if}
							{if $Record.Beds > 0}
								<tr>
									<td nowrap>Beds</td>
									<td>{$Record.Beds|number_format}</td>
								</tr>
							{/if}
							{if $Record.BathsFull > 0}
								<tr>
									<td nowrap>Baths</td>
									<td>{$Record.BathsFull|number_format}</td>
								</tr>
							{/if}
							{if $Record.SQFT > 0 && $Record.ListPrice > 0}
								<tr>
							...
							{if (isset($Record.HOAFee) && $Record.HOAFee != '') || (isset($Record.HOAFrequency) && $Record.HOAFrequency != '')}
								<tr>
									<td nowrap class="px-3">HOA Fees</td>
				...
				<div class="card mb-5 mt-3 bg-white text-left te-card border-0" id="location-hash">
					...
					<div class="card-body p-0">
						...
						<iframe width="100%" height="400" style="left: unset; position: unset;" id="gmap_canvas" src="https://maps.google.com/maps?key={$google_api_key}&q={$Record.StreetNumber} {if isset($Record.StreetDirPrefix) && $Record.StreetDirPrefix != ''}{$Record.StreetDirPrefix}{/if} {$Record.StreetName},{$Record.CityName},{$Record.State},{$Record.ZipCode}&output=embed" frameborder="0" scrolling="no"></iframe>
				...
				{*{if $virtual_url_link != ''}
					<div class="card mb-5 mt-3 bg-white text-left te-card border-0" id="location-hash">
						...
						<div class="card-body p-0">
							...
							<iframe width="100%" height="400" id="tour_canvas" src="{$virtual_url_link}" frameborder="0" scrolling="no"></iframe>
						</div>
					</div>
				{/if}*}
				...
				<div class="property_information_section expandDiv d-none d-md-block">
					<div class="card bg-white text-left te-card rounded-0 border-0" id="property-information-hash">
						<h4 class="mb-4 te-pd-all-features-main-title txt-heading">Property Information {*for {$Record.address_short}*}</h4>
						...
						<div class="card-body brd-body te-gutter-colum py-3 px-4" style="border-right: 1px solid #dfdfdf; border-left: 1px solid #dfdfdf">
							...
							{if isset($Record.Dining) && $Record.Dining != ''}
								<div>
									<ul class="list-unstyled text-dark pb-4 m-0 te-list-style-property-detail te-font-size-14">
										<div class="NoBreakSection">
											<h6 class="te-pd-sub-title pb-0 txt-heading ">Room Information</h6>
											{if isset($Record.Dining) && $Record.Dining != ''}
							...
							{if isset($Recoed.Water) && $Recoed.Water != '' || (isset($Record.Frontage_Length) && $Record.Frontage_Length != '')}
								<div>
									<ul class="list-unstyled text-dark pb-4 m-0 te-list-style-property-detail te-font-size-14">
										<div class="NoBreakSection">
											<h6 class="te-pd-sub-title pb-0 txt-heading ">Waterfront</h6>
						...
						<div class="card-body brd-body te-gutter-colum py-3 px-4" style="border-right: 1px solid #dfdfdf; border-left: 1px solid #dfdfdf; border-bottom: 1px solid #dfdfdf;">
							...
							{if isset($Record.HOAFee) && $Record.HOAFee != '' || (isset($Record.HOAFrequency) && $Record.HOAFrequency != '')}
								<div>
									<ul class="list-unstyled text-dark pb-4 m-0 te-list-style-property-detail te-font-size-14">
										<div class="NoBreakSection">
											<h6 class="te-pd-sub-title pb-0 txt-heading ">Community Information</h6>
										...
										<a href="{Utility::formatListingUrl($arrConfig[Constants::OPTION_PAGE_CONFIG][Constants::OPTION_PAGE_PERMALINK_DETAIL], $SRecord)}" class="te-property-card d-block position-relative overflow-hidden">
											...
											<div class="te-gradient te-property-details te-animate text-white position-absolute te-z-index-99 te-p-5 pt-5">
												<div class="-te-gradient te-trans te-property-details te-animate px-3 py-2 text-white position-absolute te-z-index-99">
													...
													<div class="te-property-title text-truncate te-font-size-12">{$SRecord.StreetNumber} {$SRecord.StreetName}, {$SRecord.CityName}, {$SRecord.State} {$SRecord.ZipCode}</div>
												</div>
				...
				{if $Record.PropertyType == 'Residential' && $Record.ListingStatus != 'Closed'}
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-4 expandDiv d-none d-md-block px-0">
						...
						{/if}
						<h4 class="mb-4 te-pd-footer-disclaimer-title txt-heading ">More information {*about {$Record.address_short}, {$Record.CityName}, {$Record.State} {$Record.ZipCode}*}</h4>
						<p class="text-dark mb-3 txt-color seo-text ">{if $hideAddress != '' && $hideAddress == 'Yes'}{if $isUserLoggedIn != '' && $isUserLoggedIn == true}{$Record.address_short}{else}This Property{/if}{/if} is a {if $Record.Is_Waterfront == 'Yes'}waterfront{/if} {if array_key_exists($Record.SubType, $SEOSubtype)}{$SEOSubtype[$Record.SubType]}{else}{$subtype}{/if} for {if $Record.PropertyType == 'ResidentialLease'}rent{else}sale{/if} in {$Record.CityName}, {$Record.State} {$Record.ZipCode}. This property was listed for {if $Record.PropertyType == 'ResidentialLease'}rent{else}sale{/if} {if $Record.ListingDate != ''}on {$Record.ListingDate|date_format:"M d, Y"}{/if} {if $Record.Office_Name != ''}by {$Record.Office_Name}{/if} for {$currency}{$Record.ListPrice|number_format}. Located in {if $Record.Subdivision != ''}{$Record.Subdivision}{/if} {if $hideAddress != '' && $hideAddress == 'Yes'}{if $isUserLoggedIn != '' && $isUserLoggedIn == true}, {$Record.address_short}{/if}{/if} is a {if !in_array($SRecord.PropertyType, $arrPType) && !in_array($SRecord.SubType, $arrSType)}{if $Record.Beds > 0}{$Record.Beds|number_format}{else}0{/if}-bed, {if $Record.BathsFull > 0}{$Record.BathsFull|number_format}{else}0{/if}-bath,{/if} {if $Record.SQFT > 0}{$Record.SQFT|number_format}{else}0{/if} sqft {if array_key_exists($Record.SubType, $SEOSubtype)}{$SEOSubtype[$Record.SubType]}{else}{$subtype}{/if} {if $Record.YearBuilt != ''} built in {$Record.YearBuilt}{/if}.</p>
				...
				<div class="py-xl-3 expandDiv d-none d-md-block">
					{if isset($Record.SystemName) && $Record.SystemName == 'SEFMIAMI'}
						...
						<p class="px-0 text-micro txt-color" align="justify">Miami Association of Realtors MLS data last updated on {$MLS_last_update_date}.</p>
					{elseif isset($Record.SystemName) && $Record.SystemName == 'FTL'}
						...
						<p class="px-0 text-micro txt-color" align="justify">All listings featuring the BMLS logo are provided by BeachesMLS, Inc. This information is not verified for authenticity or accuracy and is not guaranteed. Copyright ©{'Y'|date} BeachesMLS, Inc.</p>
						<p class="px-0 text-micro txt-color" align="justify">Listing information last updated on {$MLS_last_update_date}.</p>
						<div class="text-micro" style="width: 80%">
							<img class = "disclaimer_img px-0" src="{$Templates_Image}both.png">
						</div>
					{elseif isset($Record.SystemName) && $Record.SystemName == {Constants::MLS_ACTRIS}}
						<p class="px-0 text-micro txt-color" align="justify">The information being provided is for consumers' personal, noncommercial use and may not be used for any purpose other than to identify prospective properties consumers may be interested in purchasing.</p>
						<p class="px-0 text-micro txt-color" align="justify">Based on information from the Austin Board of REALTORS® (alternatively, from ACTRIS) from {$MLS_last_update_date}. Neither the Board nor ACTRIS guarantees or is in any way responsible for its accuracy. The Austin Board of REALTORS®, ACTRIS and their affiliates provide the MLS and all content therein "AS IS" and without any warranty, express or implied. Data maintained by the Board or ACTRIS may not reflect all real estate activity in the market.</p>
						<p class="px-0 text-micro txt-color" align="justify">All information provided is deemed reliable but is not guaranteed and should be independently verified.</p>
					{/if}
				</div>
			</div>
			<div class="col-xl-3 col-lg-4 col-md-12 col-sm-12 col-12 aside {if cw::$screen > 'LG'}pl-0{/if}">
				<div class="row">
					{if isset($objagent.Agent_Id) && $objagent.Agent_Id != '' }
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 Featured-listings ">
						{assign var="remove" value=(isset($objagent.Agent_Photo) && $objagent.Agent_Photo == '' && isset($objagent.Agent_Photo) && $agentInfo.not_display_info == 'Yes')?'1':'0' }
						<div class="card w-100 agent-profile mt-4 mt-md-0  mt-xl-0 {if $remove == 1} mb-0 {else} mb-2 {/if} rounded-0 setbgcolor">
							{assign var="nophoto" value=(isset($objagent.Agent_Photo) && $objagent.Agent_Photo != '')?'0':'1' }
							{if isset($objagent.Agent_Photo) && $objagent.Agent_Photo != ''}
								<div class="text-center ">
									<img style="max-width: 35%; object-fit: contain" src="{$agentprofileImgUrl}{if isset($objagent.Agent_Photo) && $objagent.Agent_Photo != ''}{$objagent.Agent_Photo}{/if}" class="{*w-100 h-100*}" >
								</div>
							{/if}
							{if isset($agentInfo.not_display_info) && $agentInfo.not_display_info == 'Yes'}
								<div class=""></div>
							{else}
								<div class="{*card-body bg-white*} px-4 pb-4 formpx {*te-property-agent-detail*}">
									<p class="text-center agent-name text-capitalize {if $nophoto == 1} pt-3 {else} pt-2 {/if}">
										{if isset($objagent.Agent_Name) && $objagent.Agent_Name != ''}{$objagent.Agent_Name}{/if}
										</p>
									<ul class="list-unstyled w-100 p-0 pb-3">
										{if isset($objagent.Agent_phone) && $objagent.Agent_phone != ''}
											<li class="py-1 text-center">
												<span class="text-capitalize">Direct</span> {$objagent.Agent_phone}
											</li>
										{/if}
										{if isset($objagent.Agent_Office) && $objagent.Agent_Office != ''}
											<li class="py-1 text-center">
												<span class="text-capitalize">Office</span> {$objagent.Agent_Office}
											</li>
									...
									<a type="button" href="#request-detail" {*href="JavaScript: void(0);"*} {*data-url="{$detail_url}?action=listing-inquiry"*} class="btn border-secondary- btn_txt_color shadow-none rounded-0 w-100 text-uppercase btn-schedule lpt-btn lpt-btn-txt button_color {*hbn-popup-modal*} hover-color hover-text-color" id="contact_us" {*data-toggle="modal" data-target="Inquiry"*} >
										Contact Agent</a>
								</div>
							{/if}
						</div>
					...
					{else}
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 Featured-listings ">
							{assign var="remove" value=(isset($agentInfo.agent_photo) && $agentInfo.agent_photo == '' && isset($agentInfo.not_display_info) && $agentInfo.not_display_info == 'Yes')?'1':'0' }
							<div class="card w-100 agent-profile mt-4 mt-md-0  mt-xl-0 {if $remove == 1} mb-0 {else} mb-2 {/if} rounded-0 setbgcolor">
								{assign var="nophoto" value=(isset($agentInfo.agent_photo) && $agentInfo.agent_photo != '')?'0':'1' }
								{if isset($agentInfo.agent_photo) && $agentInfo.agent_photo != ''}
									<div class="text-center ">
										<img style="max-width: 100%; object-fit: contain" src="{$agentImgUrl}{if isset($agentInfo.agent_photo) && $agentInfo.agent_photo != ''}{$agentInfo.agent_photo}{/if}" class="{*w-100 h-100*}" >
									</div>
								{/if}
								{if isset($agentInfo.not_display_info) && $agentInfo.not_display_info == 'Yes'}
									<div class=""></div>
								{else}
									<div class="{*card-body bg-white*} px-4 pb-4 formpx {*te-property-agent-detail*}">
										<p class="text-center agent-name text-capitalize {if $nophoto == 1} pt-3 {else} pt-2 {/if}">
											{if isset($agentInfo.agent_name) && $agentInfo.agent_name != ''}{$agentInfo.agent_name}{/if}
										</p>
										<ul class="list-unstyled w-100 p-0 pb-3">
											{if isset($agentInfo.agent_phone) && $agentInfo.agent_phone != ''}
												<li class="py-1 text-center">
													<span class="text-capitalize">Direct</span> {$agentInfo.agent_phone}
												</li>
											{/if}
											{if isset($agentInfo.agent_office) && $agentInfo.agent_office != ''}
												<li class="py-1 text-center">
													<span class="text-capitalize">Office</span> {$agentInfo.agent_office}
												</li>
											{/if}
											{*<li class="py-2 text-truncate"><i class="far fa-envelope pr-2 text-secondary"></i> {if isset($agentInfo.agent_email) && $agentInfo.agent_email != ''}{$agentInfo.agent_email}{/if}
                                            </li>*}
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div id="request-detail" class="card w-100 rounded-0 {if $remove == 1} mt-0 {else} mt-4 mt-md-0 mt-lg-4 {/if} te-request-detail">
