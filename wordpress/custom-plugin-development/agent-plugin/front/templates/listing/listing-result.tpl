...
<div class="wrapper te-search-result-wrapper pms-map-listing customize-ldesign {if isset($isstyle) && ($isstyle !== false) && $isstyle == 7} slider-7{/if} {if isset($isPredefined) && ($isPredefined == 'true' || $isPredefined == true)}no-follow-link{/if}">
    <section class="te-search-results-sec  p-0 {if isset($isstyle) && ($isstyle !== false) && $isstyle == 1} slider-1{/if}">
        <div class="{if isset($isGrid) && $isGrid !== 'true' && ($isstyle != 9 && $isstyle != 10 && $isstyle != 11)}container-fluid{elseif isset($isstyle) && ($isstyle !== false) && $isstyle != 9 && $isstyle != 10 && $isstyle != 11} con-style {else} {if isset($isPredefined) && $isPredefined == true && $isstyle != 9 && $isstyle != 10 && $isstyle != 11}container-fluid pt-0{else}container con-div p-xl-0 p-md-0 pt-0{/if}{/if}">
...
<script type="text/javascript">
    ...
    var userFavList	    = '{if isset($userFavList) && is_array($userFavList)}{', '|implode:$userFavList|lower|ucwords}{else}{$userFavList|default:''}{/if}';
    var isPredefined    = '{if isset($isPredefined)}{$isPredefined}{/if}';
    var isAgentPre    = '{if isset($isAgentPre)}{$isAgentPre}{/if}';
    var isstyle         = '{if isset($isstyle)}{$isstyle}{/if}';
    var arrPType	    = '{$arrPType|json_encode}';
    var arrSType	    = '{$arrSType|json_encode}';
    ...
    var AgentCryptoValue    = {$AgentCryptoValue};
    var bitcoin         = '{$bitcoin}';
    ...
    var hideAddress = '{$hideAddress}';
    var agent_Profile_Id   = '{if isset($agent_Profile_Id)}{$agent_Profile_Id}{/if}';
</script>