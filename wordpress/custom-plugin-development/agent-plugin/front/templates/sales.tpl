<section class="py-5- pb-5 te-font-family">
	<div class="container-fluid con-mar te-market-report-container px-md-4- px-0">
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 offset-xl-1-">
				<div class="row te-search-filter-row- justify-content-between pre-filter-line pb-0 pb-md-2 p-md-0 m-md-0 btn-align btn-gray pl-xl-3- customize-market-design offset-xl-1">
					<div class=" col-xl-8 col-lg-9 col-md-9 col-12 px-1- px-md-2 px-0 text-lg-left text-xl-left text-md-left align-self-center offset-xl-1 {if cw::$screen == 'XS' || cw::$screen == 'SM' || cw::$screen == 'MD'}border-btm{/if} text-center py-2 pt-xl-2 pb-md-0 ">
						<a href="{$Site_Url}{str_replace(' ', '-', $pre_search['psearch_title'])}" class="btn btn-sm font-size-sm-12 font-size-sm-10 te-font-size-13  shadow-none pl-3- p-lg-2 p-xl-2 px-1 te-pre-saveser rounded-0 {*{if !isset($Action) ||  (isset($Action) && $Action == '')} te-btn lpt-btn lpt-btn-txt{else} tab-btn{/if}*} "><i class="fa fa-th pr-md-1 pr-0 {if cw::$screen == 'XS'} fa-1x {else} fa-2x {/if} align-middle"></i>  {if cw::$screen == 'XS'} GRID {else} GRID VIEW {/if}</a>
						<a href="{$Site_Url}{Constants::TYPE_SALES}/{str_replace(' ', '-', $pre_search['psearch_title'])}" class="btn btn-sm font-size-sm-10 font-size-sm-12 te-font-size-13  shadow-none  p-lg-2 p-xl-2 px-1 te-pre-saveser rounded-0 {*{if isset($Action) && $Action == Constants::TYPE_SALES} lpt-btn lpt-btn-txt te-btn {else} tab-btn {/if}*}"><i class="fa fa-list pr-md-1 pr-0 {if cw::$screen == 'XS'} fa-1x {else} fa-2x {/if} align-middle"></i> {if cw::$screen == 'XS'} LIST {else} LIST VIEW {/if}</a>
						...
						{if cw::$screen == 'XS'}
							<div class="dropdown d-inline-block mx-1- mx-lg-0 px-2 px-sm-2 d-sm-none">
								<button class="btn btn-sm dropdown-toggle- font-size-sm-12 te-font-size-13 te-btn- text-white- shadow-none p-lg-2 p-xl-2 px-1 te-share-propery-detail rounded-0 w-100 lpt-btn- lpt-btn-txt-" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									<i class="fas fa-share-alt fa-2x align-middle pr-2"></i><span class="d-md-none d-lg-inline"></span>
								</button>
								<div class="dropdown-menu border rounded-0" aria-labelledby="dropdownMenuButton">
									<a class="dropdown-item font-size-14 py-1" href="https://www.facebook.com/share.php?u={$shareUrl}" target="_blank"><i class="fab fa-facebook-f pr-2"></i> Facebook</a>
									<a class="dropdown-item font-size-14 py-1" href="https://twitter.com/share?url={$shareUrl}" target="_blank"><i class="fab fa-twitter pr-1"></i> Twitter</a>
					...
					<div class="col-12 col-xl-3 col-lg-3 col-md-3 px-0 px-lg-0 pt-2 px-xl-2 d-none d-sm-block text-center text-md-right text-xl-center">
						<div class="dropdown d-inline-block mx-1- mx-lg-0">
							<button class="btn btn-sm dropdown-toggle- font-size-sm-12 te-font-size-13 te-btn- text-white- shadow-none p-lg-2 p-xl-2 px-1 te-share-propery-detail rounded-0 w-100 lpt-btn- lpt-btn-txt-" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<i class="fas fa-share-alt fa-2x align-middle pr-2"></i><span class="d-md-none d-lg-inline">Share</span>
							</button>
							<div class="dropdown-menu border rounded-0" aria-labelledby="dropdownMenuButton">
								<a class="dropdown-item font-size-14 py-1" href="https://www.facebook.com/share.php?u={$shareUrl}" target="_blank"><i class="fab fa-facebook-f pr-2"></i> Facebook</a>
								<a class="dropdown-item font-size-14 py-1" href="https://twitter.com/share?url={$shareUrl}" target="_blank"><i class="fab fa-twitter pr-1"></i> Twitter</a>
				...
				{if isset($arrRecord) && count($arrRecord) > 0}
					<div class="row">
						<div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 pt-4 offset-xl-1 px-md-4 px-4">
						...
						<div class="col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 pt-2 offset-xl-1 px-md-4 px-4">
					...
					{if isset($Action) && $Action!= Constants::TYPE_SOLD}
						<div class="row pt-4">
							<div class="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-12 pt-md-0 pt-4 offset-xl-1 px-4">
							...
							<div class="col-xl-5 col-lg-6 col-md-6 col-sm-6 col-12 -pr-0 pt-md-0 pt-3 px-4">
