<section id="te-market-report-container te-font-family" class="{*py-5*} px-xl-5">
                ...
                {if is_array($statistic) && count($statistic) > 0}
                    ...
                    <div class="row pt-3- market-statistics text-dark- {if $attr['background'] == 'dark'} pre_market_text_dark{else}pre_market_text_light{/if}">
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 pt-1- pr-xl-3">
                            <h3 class="title-font text-center te-market-title- text-border-bottom market-title pt-4 pb-4 {if $attr['background'] == 'dark'} pre_market_text_dark{else}pre_market_text_light{/if}">For Sale</h3>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 pt-1- px-xl-3">
                            <h3 class="title-font text-center te-market-title- text-border-bottom market-title pt-4 pb-4 {if $attr['background'] == 'dark'} pre_market_text_dark{else}pre_market_text_light{/if}">Pending Sales</h3>
                            <ul class="p-0 pt-3">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 pt-1- pl-xl-3">
                            <h3 class="title-font text-center te-market-title- text-border-bottom market-title pt-4 pb-4 {if $attr['background'] == 'dark'} pre_market_text_dark{else}pre_market_text_light{/if}">Closed Sales</h3>
                            <ul class="p-0 pt-3">
