...
class Front
{
	...
	public function initialize()
	{
        ...
        /*add_action( 'wp_enqueue_style', array($this, 'lpt_styles'), 40);

        add_action( 'wp_enqueue_scripts', array($this, 'lpt_scripts'));*/


//        wp_enqueue_style( 'css-jQuery', $arrVirtualPath['Libs']. 'jQuery/jquery-ui.css',array(),Constants::CSS_JS_VERSION);

        //add_action( 'wp_enqueue_style', array($this, 'lpt_styles'), 60);
        ...
        add_shortcode('development-result', array(ShortcodeHandler::getInstance(), 'DevelopmentPageResult') );
...
//        wp_enqueue_style( 'css-jQuery', $arrVirtualPath['Libs']. 'jQuery/jquery-ui.css',array(),Constants::CSS_JS_VERSION);
        ...
        if(isset($arrConfig['OtherConfig']['google_conv_code']) && $arrConfig['OtherConfig']['google_conv_code'] != ''){

            wp_register_script( 'google-conv-js', 'https://www.googleadservices.com/pagead/conversion_async.js', null, null );
            wp_enqueue_script('google-conv-js');
        }
        ...
        //wp_enqueue_style('ore-color-style', $arrVirtualPath['TemplateCss']. 'color.php',array(),Constants::CSS_JS_VERSION);
...
xmlns:fb="https://www.facebook.com/2008/fbml"';
    ...
    function add_login_logout_link($items, $args) {
        ...
        if($arrConfig['OtherConfig']['login_enable'] == 'Yes')
        {
            if (is_user_logged_in()) {
                ...
                $loginoutlink = '<li class="nav-item- dropdown logoutlink">
        <a class="nav-link myaccount -dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">My Account</a>
    ...
    function insert_my_footer() {
        $poup = '<div class="modal fade header-sign-in" id="modal-sm-popup" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    function lpt_styles(){
        ...
        wp_enqueue_style( 'ore-jquery-ui-css', $arrVirtualPath['Libs']. 'jQuery/jquery-ui-1.12.0/jquery-ui.css',array(),Constants::CSS_JS_VERSION);
        wp_enqueue_style( 'ore-jquery-ui-theme-css', $arrVirtualPath['Libs']. 'jQuery/jquery-ui-1.12.0/jquery-ui.theme.css',array(),Constants::CSS_JS_VERSION);
        wp_enqueue_style( 'p-bootstrap', 'https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css',array("parente2-style"),Constants::CSS_JS_VERSION);
//        wp_enqueue_style( 'css-jQuery', $arrVirtualPath['Libs']. 'jQuery/jquery-ui.css',array(),Constants::CSS_JS_VERSION);
