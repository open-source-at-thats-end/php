...
class Color
{
    ...
    public $quick_srch_fnt_fmly;
    public $quick_title_transform;
    public $quick_search_transform;
    public $quick_title_space;
    ...
    public function initialize()
    {
        ...
        $this->btn_color = $opt['btn_color'];
        $this->btn_txt_color = $opt['btn_txt_color'];
        $this->txt_color = $opt['text_color'];
        $this->main_font_family = $opt['main_font_family'];
        $this->heading_txt_color = $opt['heading_txt_color'];
        $this->link_color = $opt['link_color'];
        ...
        $this->quick_srch_fnt_fmly = $opt['quick_srch_fnt_fmly'];
        $this->quick_title_transform = $opt['quick_title_transform'];
        $this->quick_search_transform = $opt['quick_search_transform'];
        $this->quick_title_space = $opt['quick_title_space'];
...
/*Quick Search start*/
    ...
    select.quick_srch_fnt_fmly{
        font-family: <?php echo Color::getInstance()->quick_srch_fnt_fmly ?> !important;
    }
    .quick-btn .quick_srch_fnt_fmly{
        font-family: <?php echo Color::getInstance()->quick_srch_fnt_fmly ?> !important;
    }
    .quick_font_family{
    ...
    /*.listings-box .te-font-family{
        font-family: <?php echo Color::getInstance()->main_font_family ?>, sans-serif!important;
    }
    .properties-slider.te-font-family, .properties-slider h3, .style2-property-box.te-font-family, .properties-slider-3.te-font-family, .slick-slide .te-font-family, .te-font-family h5{
        font-family: <?php echo Color::getInstance()->main_font_family ?>, sans-serif!important;
    }
   .te-font-family{
        font-family: <?php echo Color::getInstance()->main_font_family ?>, sans-serif!important;
