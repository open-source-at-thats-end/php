...
function getMainBoxHtml(obj, fav) {
   ...
   infoHtml += '<a href="'+ Site_Url+obj.SFUrl+'" class="'+h_class+' p10 card te-font-family te-style-10 position-relative overflow-hidden border-0 rounded-0">\n' +
                  '<span class="listing-status position-absolute font-weight-bold">'+status+'</span>' ;
   ...
   infoHtml +=  '</div>\n' +
                  ...
                  '<div itemprop="name" class="card-text pb-2- te-font-size-15 te-font-weight-600">' + currency + numberFormat(obj.Price) ;
                     ...
                     infoHtml +=  '</div> <div class="w-50 float-left float-start-"><div class="pb-1- te-font-size-12 te-font-weight-600">'+obj.Address2+'</div>' +
                         '<div class="pb-2- te-font-size-12 te-font-weight-600">'+obj.CityName+', '+ obj.State +' '+obj.ZipCode+'</div></div>' +
                         ...
                         '<div class="w-50 float-right float-end- text-right"><div class="te-property-details-features te-font-size-12"><ul class="d-flex text-center te-font-weight-600 justify-content-end p-0 te-font-size-12 pb-2- "><li class="border-right px-2 px-lg-2 px-xl-2 text-center">'+obj.Bed+' </br> Beds </li>  <li class="border-right px-2 px-lg-2 px-xl-2  text-center">'+obj.BathsFull+' </br> Baths </li> <li class="pl-2 pl-lg-2 pl-xl-2 text-center"> '+numberFormat(obj.Sqft)+' </br> Sq. Ft.</li></ul></div></div>' +
                         '</div>' +
                         '</a></div>' ;
