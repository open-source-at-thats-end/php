...
{
    /*jQuery('.slider-'+pid+'').on("afterChange", function (){
        changeAddress();
    });*/
...
if(pid != ''){
   ...
   /* infoHtml += '<div class="p-5" style="'+styleCSS+'">Sold Properties</div>';*/
    infoHtml += '<div class="properties-slider p-slider9-'+pid+' p-slider-9 card bg-transparent border-0 pt-3 pb-1">';
    ...
    infoHtml += '</div>';*/
    /* Demo HTML */
    infoHtml += '<div id="'+obj.Key+'" data-ref-id="'+obj.Key+'" class=""><a href="'+ Site_Url+obj.SFUrl+'" class="p-info- pb-0 te-property-card te-style-9 te-font-family overflow-hidden">' +
                    '<p class="listing-status position-absolute font-weight-bold">'+status+'</p>';
        ...
        infoHtml +=  '</div> <div class="w-50 float-left float-start-"><div class="pb-1- te-font-size-12 font-weight-600">'+obj.Address2+'</div>' +
                        '<div class="pb-2- te-font-size-12 font-weight-600">'+obj.CityName+', '+ obj.State +' '+obj.ZipCode+'</div></div>' +
                        ...
                        '<div class="w-50 float-right float-end- text-right"><div class="te-property-details-features te-font-size-12"><ul class="d-flex text-center te-font-weight-600 justify-content-end p-0 te-font-size-12 pb-2- "><li class="border-right style9_text_color px-2 px-lg-2 px-xl-2 text-center">'+obj.Bed+' </br> Beds </li>  <li class="border-right style9_text_color px-2 px-lg-2 px-xl-2  text-center">'+obj.BathsFull+' </br> Baths </li> <li class="pl-2 pl-lg-2 pl-xl-2 text-center"> '+numberFormat(obj.Sqft)+' </br> Sq. Ft.</li></ul></div></div>' +
                    '</div>' +
                '</a></div>' ;
    });
    infoHtml += '</div>';
