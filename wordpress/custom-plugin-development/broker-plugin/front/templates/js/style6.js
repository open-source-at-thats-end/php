...
function getMainBoxHtml(obj, fav) {
    ...
    infoHtml += '<a href="'+ Site_Url+obj.SFUrl+'" class="listings-height d-block te-property-gradient te-style-6 te-font-family position-relative overflow-hidden">';
    ...
    if(obj.Type == "ResidentialLease"){
        ...
        infoHtml += '<li class="pr-3 px-1 text-center"><img class="d-block mx-auto mb-1" src="'+Site_Url+'API/upload/pictures/bitcoin.png" alt="bitcoin"> APPROX <strong class="d-block">'+ numberFormat(Math.round(obj.Price / bitcoin)) +'</strong></li>';
