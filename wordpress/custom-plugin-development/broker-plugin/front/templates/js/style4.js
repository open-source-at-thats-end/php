...
function getMainBoxHtml(obj, fav) {
    ...
    if(obj.Type == "ResidentialLease"){
        ...
        infoHtml += '<li class="pr-1 text-center"><img class="d-block mx-auto mb-1 te-font-weight-400 " src="'+Site_Url+'API/upload/pictures/bitcoin.png" alt="bitcoin"> APPROX <span class="d-block">'+ numberFormat(Math.round(obj.Price / bitcoin)) +'</span></li>';

        infoHtml += '<li class="px-1 text-center"><img class="d-block mx-auto mb-1 te-font-weight-400 " src="'+Site_Url+'API/upload/pictures/etherium.png" alt="etherium"> APPROX <span class="d-block">'+ numberFormat(Math.round(obj.Price / etherium)) +'</span></li>';
