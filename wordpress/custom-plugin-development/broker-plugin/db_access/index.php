...
$MyUpdateChecker = PucFactory::buildUpdateChecker(
	...
	'https://CustomWpPluginDemoDomain.com/API/plugin/metadata.json',
...
if(strpos($_SERVER['HTTP_HOST'], 'project') !== false)
{
    $arrConfig['idxapi_url'] = 'http://CustomWpPlugin-api.project:'.$_SERVER['SERVER_PORT'].'/apis/DataFetcher.php';
    $arrConfig['autosugg_url'] = 'http://CustomWpPlugin-api.project:'.$_SERVER['SERVER_PORT'].'/autosuggest.php';
    $arrConfig['upload_url'] = 'http://CustomWpPlugin-api.project:'.$_SERVER['SERVER_PORT'].'/upload/';
}
elseif(strpos($_SERVER['HTTP_HOST'], 'thatsend') !== false)
{
    ...
    $arrConfig['autosugg_url'] = $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'].'/API/autosuggest.php';
...
function my_mail_from( $email ) {
    ...
    //return "CustomWpPluginmedia@gmail.com";
}
