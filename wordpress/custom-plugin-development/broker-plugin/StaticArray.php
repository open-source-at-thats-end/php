<?php
/**
 * loopt plugin related constants.  These are used in many
 * different classes.
 *
 * @author -
 */
class StaticArray {
	...
	{
		return array('ajax_in_site', 'action', 'XHR', 'getMapData', 'isBackSearch', 'page_size', 'mz', 'clat', 'clng', 'issorting', 'issavesearch','psearch_tag','psearch_generate_mrktreport','AddressName','isFilter','isHeading','psearch_generate_rental','is_map','disclaimer','tabs','sys_name','membership_required','membership_fee');
	}
	...
	public static function arrSortingOption(){
		return array(   //'ListPrice|desc'        =>  'Price',
		                ...
		                //'domprice|desc'    =>  'Newest From Most Expensive',
		                /*'sold|desc'        =>  'Sold Date',
    ...
    public static function arrAgentSystemName(){
        return array(
            /*Constants:: MARBEACHES  => 'MAR/BEACHES',
            Constants:: ACTRIS      => 'ACTRIS',*/
            '1'  => 'MAR/BEACHES',
            '2'  => 'ACTRIS',
        );
    }
...
//			'' 	=> 'All',
	...
	public static function UserMeta(){
		return array ('user_phone','user_first_name','user_last_name','user_address','user_preference','user_time','user_ptype',
    ...
    public static function arrTimeFrame(){
    ...
    public static function arrLeadType(){
    ...
    public static function arrSource(){
        ...
        return array(
            ...
            'Paid Ads-Google' 	    => 'Paid Ads-Google',
            'Paid Ads Por-tal' 	    => 'Paid Ads Por-tal',
            'Paid Ads AdWerx' 	    => 'Paid Ads AdWerx',
            'Paid Ads Facebook' 	=> 'Paid Ads Facebook',
            'Paid Ads Instagram'    => 'Paid Ads Instagram',
        );
    }
    public static function arrSubscription(){

        return array(
            'Property Alerts'   => 'Property Alerts',
            'Auto-Followup' 	=> 'Auto-Followup',
    ...
    public static function arrPropertyType() {
        return array ('Land','BusinessOpportunity'/*,'ResidentialLease'*/,'ResidentialIncome','CommercialLease','CommercialSale');
    }

    public static function arrSubType() {
        return array('Commercial','HotelMotel','Industrial','MultiFamily','BoatSlip','Income','Farm');
    }
    public static function arr_SName_MLS(){
        return array(
