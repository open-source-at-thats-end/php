    ...
    <table width="100%" align="center" style="/*background: #fff;*/padding: 15px;width: 650px;">
        <tr>
            <td class="logo250-" style="text-align: center; line-height: 1px;width: 100%;border-bottom:1px solid #e6e6e6; padding: 5px;">
                {if isset($AgentInfo['print_photo']) && $AgentInfo['print_photo'] != ''}
                    ...
                    <div style="color: #585858;box-shadow: none;overflow: hidden;display: block;text-decoration: none;background: #ececec;">
                        <a href="{Utility::formatListingUrl($arrConfig[Constants::OPTION_PAGE_CONFIG][Constants::OPTION_PAGE_PERMALINK_DETAIL], $Record)}" style="color: #585858;box-shadow: none;overflow: hidden;display: block;text-decoration: none;background: #ececec;">
                            {if $Record.mls_is_pic_url_supported == 'Yes'}
                                ...
                                {if $photo_url != ''}
                                    <img src="{$photo_url}" alt="{$Record.StreetNumber} {$Record.StreetDirPrefix} {$Record.StreetName}-1" width="100%" style="min-height: 350px;max-height: 350px;width: 100%;"/>
                                {else}
                                    <img src="{$PhotoBaseUrl}/no-photo/0/0/" alt="{$Record.StreetNumber} {$Record.StreetDirPrefix} {$Record.StreetName}-1" width="100%" style="min-height: 350px;max-height: 350px;max-width: 100%;height: auto; !important;"/>
                                {/if}
                            {else}
                                <img src="{$Record.MainPicture}" alt="{$Record.StreetNumber} {$Record.StreetDirPrefix} {$Record.StreetName}-1" width="100%" style="min-height: 350px;max-height: 350px;max-width: 245%;height: auto; !important;"/>
                            {/if}
