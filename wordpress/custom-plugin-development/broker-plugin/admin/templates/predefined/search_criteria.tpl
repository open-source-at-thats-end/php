{if is_array($arrSearchResult) && count($arrSearchResult) > 0}
    {if isset($arrSearchResult.mlslist) && !empty($arrSearchResult.mlslist)}
       {* <strong>#MLS: </strong>{if is_array($arrSearchResult.mlslist)}{$arrSearchResult.mlslist|implode:', '}{else}{$arrSearchResult.mlslist}{/if}<br />*}
    ...
    {if isset($arrSearchResult.sdiv)}
        <strong>Subdivision: </strong>{if is_array($arrSearchResult.sdiv)}{', '|implode:$arrSearchResult.sdiv|implode:', '|lower|ucwords}{else}{$arrSearchResult.sdiv}{/if}
        <br>
    {/if}
    ...
    {if isset($arrSearchResult.city)}
       {* <strong>City: </strong>{if is_array($arrSearchResult.city)}{$arrSearchResult.city|implode:', '}{else}{$arrSearchResult.city}{/if}<br />*}
    ...
    {if isset($arrSearchResult.kword) && !empty($arrSearchResult.kword)}
        <strong>Additional: </strong> {$arrSearchResult.kword}<br />
    {/if}
    ...
    {*{if isset($arrSearchResult.waterfrontdesc) && !empty($arrSearchResult.waterfrontdesc)}
        <strong>Waterfront Description: </strong> {$arrSearchResult.waterfrontdesc}<br />
    {/if}*}
