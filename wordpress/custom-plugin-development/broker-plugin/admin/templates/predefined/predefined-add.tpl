            ...
            <div class="row-fluid">
                <div class="span10-">
					...
					<div class="fholder2">
						...
						{/if}
						<b class="pl-10"><input type="checkbox" id="psearch_display_tab" name="psearch_display_tab" value="Yes" {if $rsPredefined.psearch_display_tab == 'Yes'}checked{/if} class="input-lg"/> Display Tab Layout?</b><br>
                        <b class=""><input type="checkbox" id="psearch_monthwise_report" name="psearch_monthwise_report" value="Yes" {if $rsPredefined.psearch_monthwise_report == 'Yes'}checked{/if} class="input-lg"/> Generate Monthwise Market Report</b>
					</div>
                    <br class="fclear">
