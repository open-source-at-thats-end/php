<div>
    <div class="fholder2">
        <label><b>MLS#</b></label><br>

        <input type="text" id="mlslist" name="mlslist" value="{$arrSearchCriteria.mlslist}" class="input-lg for-search"/>
    </div>
    <div class="fholder2">
        <label><b>Address</b></label><br>
       {* <input type="text" id="add" name="add" value=" {if empty($arrSearchCriteria.add)} {else}{','|implode:$arrSearchCriteria.add}{/if}" class="input-lg for-search"/>*}
    ...
    <div class="fholder2 pt-10">
      ...
      {*  {if isset($AgentSystemName) && $AgentSystemName == {constant('Constants::ACTRIS')}}
            ...
            <div class="multi-opt cols3 multi-options-container ProperTypeActris">
                ...
                *}{*{include file='save_search_ptype_actris.tpl'}*}{*
            </div>
        {else}
            <label><b>MIAMI/BEACHES</b></label><br>*}
            <div class="multi-opt cols3 multi-options-container ProperTypeActris">
   ...
   {* {if isset($AgentSystemName) && $AgentSystemName != {constant('Constants::ACTRIS')}}*}
        <div class="fholder2 pt-10">
            <label class="prpty-style"><b>Property Style</b></label><br>
            <div class="multi-opt cols3 multi-options-container prpty-style">
                {foreach name=pstyle from=$arrMeta['PropertyStyle'] key=skey item=sitem}
                    <label><input type="checkbox" class="pstyle" name="pstyle[]" {if  (isset($arrSearchCriteria.pstyle)) &&  ($skey|in_array:$arrSearchCriteria.pstyle || $skey == $arrSearchCriteria.pstyle)}checked="checked"{/if} id="{$skey}" value="{$skey}" />&nbsp;{$sitem}</label>
                {/foreach}
            </div>
        </div>
   {* {/if}*}
    <div class="fholder2 pt-10">
        <label><b>Days on Market</b></label><br>
    ...
    <div class="fholder2">
        <label><b># of Bedrooms</b></label><br>
    ...
    <div class="fholder2">
        <label><b># of Bathrooms</b></label><br>
   ...
   {* {if isset($AgentSystemName)  && $AgentSystemName != {constant('Constants::ACTRIS')}}*}
    ...
    {*{/if}*}
    <div class="fholder2">
        <label><b>Horse Amenities</b></label><br>
    ...
    <div class="fholder2">
       {* <div class="col6">*}
            <label><b>Waterfront Description</b></label><br>
            <select name="waterfrontdesc" class="apm_monoselect input-lg WaterFrontDesc">
                <option value="">Any</option>
                {html_options options=$arrWaterfrontDesc selected=$arrSearchCriteria.waterfrontdesc}
                {*{include file='save_search_options.tpl'}*}
            </select>
        {*</div>*}
    </div>
    {*{if isset($AgentSystemName)  && $AgentSystemName != {constant('Constants::ACTRIS')}}*}
        <div class="fholder2">
            {*<div class="col6">*}
                <label class="security"><b>Security</b></label><br>
