...
define('AWS_S3_ACCESS_KEY_ID',     'AKIAXKJXK2I5FTQHYSVN');
define('AWS_S3_ACCESS_SECRET_KEY',     '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');
define('AWS_S3_BUCKET_NAME',     'CustomWpPlugin-media');
define('AWS_S3_REGION',     'us-east-2');
define('S3_BUCKET_URL','https://CustomWpPlugin-media.s3.us-east-2.amazonaws.com');
//define('S3_BUCKET_URL','https://d2cktaqxob1opr.cloudfront.net');
define('S3_BUCKET_FOLDER_TRESTLE','trestle');
define('S3_BUCKET_FOLDER_ACTRIS','actris');

if( !interface_exists('Constants')){
    interface Constants{
        const DEBUG = false;

        const CSS_JS_VERSION = 94;
	    ...
	    const TYPE_IP_LOCATION="ip-location";
        ...
        const COINLAYER_ACCESS_KEY='040aead77839742bde6454e50efc95a5';
    }
}
?>