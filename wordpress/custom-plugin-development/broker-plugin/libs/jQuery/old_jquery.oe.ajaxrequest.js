    ...
    (function($) {
        jQuery._jAjaxCall = function(options) {
            ...
            this.init = function(options){
                if(options.abort_on_new_req === true && _this.currentRequest != null){
            ...
            this.jAjaxRequest = function(){
                ...
                _this.currentRequest = jQuery.ajax({
                    ...
                    complete    :   function(jqXHR, textStatus){
                        ...
                        {
                            _this._o.fn_alert('error','Sorry, your request has been timed out. Please try again. If you are experiencing this problem multiple times then try to reload page [press CNT and R key] or you can contact your administrator.');
                        }
                        else if(textStatus === 'parsererror')
                        {
                            _this._o.fn_alert('error','Sorry, your request has been terminated. Please try again. If you are experiencing this problem multiple times then try to reload page [press CNT and R key] or you can contact your administrator.');
                        }
